...
Run each file in sequence (see **`migrations/README.md`** for order, idempotency, optional `verify_schema.sql`, and **`migrations/SEEDS.md`** for bcrypt / seed data). In phpMyAdmin: select `mimds` → **Import** tab → choose file.
